...
inventoryRoutes.get("/", permissions("canView"), controller.inventory); inventoryRoutes.get("/low-stock", permissions("canView"), controller.lowStock); inventoryRoutes.post("/stock-in", permissions("canUpdate"), controller.stockIn); inventoryRoutes.post("/stock-out", permissions("canUpdate"), controller.stockOut);
